...
The dataset provides three data tables including order_and_shipment, inventory and fulfillment. After examining the data fields, the dataset generally represents the following key information:
